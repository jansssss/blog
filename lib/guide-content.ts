...
export const STATIC_GUIDES: readonly StaticGuide[] = [
  {
    ...
    homeTitle: '대출금리 산정내역서',
    href: '/guide/loan-rate-statement',
    description: '기준금리·가산금리·우대금리와 COFIX 재산정 주기를 비교하고 2026년 7월 은행법 개정 적용 범위를 확인합니다.',
    homeDescription: '기준·가산·우대금리와 COFIX 비교',
    tag: '금리 비교',
    cluster: '금리·상환',
    indexOrder: 1,
    publishedAt: '2026-09-14',
    publishedAtTime: '2026-09-14T10:19:34+09:00',
  ...
  },
  {
    ...
    cluster: '전세·보증',
    indexOrder: 23,
    // GSC 28일 창(2026-08-15~09-11): 7노출·2클릭·CTR 28.6%
    gscHit: { asOf: '2026-09-11', clicks: 2, impressions: 7 },
    ...STYLES.violet,
  },
  {
    title: '대출 거절 극복 전략',
