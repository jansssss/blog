        ...
        <div className="mt-10 rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-blue-50 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">부담 확인 후 이어서 계산해보세요</p>
            </div>
          </div>
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              { href: '/calculator/dsr-dti-ltv', emoji: '📋', title: 'DSR · DTI · LTV 계산기', desc: '소득 대비 대출 한도를 정확히 확인' },
              { href: '/calculator/loan-interest', emoji: '📊', title: '대출 이자 계산기', desc: '월 납입액과 총이자 상세 계산' },
              { href: '/calculator/repayment-compare', emoji: '⚖️', title: '상환방식 비교', desc: '방식 바꾸면 월 부담이 얼마나 달라지나' },
              { href: '/calculator/emergency-fund', emoji: '🛡️', title: '비상자금 계산기', desc: '상환하면서 비상자금 얼마나 남겨야 하나' },
