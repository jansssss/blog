...
export default function CarLoanDsrImpactPage() {
  return (
    ...
    >
      ...
      <P>
        집을 알아보다가 &ldquo;자동차 할부도 DSR에 포함됩니다&rdquo;라는 말을 처음 들으면 당황스럽습니다.
        차를 담보로 빌린 것도 아니고, 집을 담보로 빌리는 돈인데 왜 차 할부가 영향을 주는 건지.
        은행의 논리는 이렇습니다: <em>&ldquo;이 사람은 매달 차 할부로 50만원을 내고 있다. 그 50만원이 빠지고 나서 주담대를 얼마나 더 감당할 수 있는지를 봐야 한다.&rdquo;</em>
      </P>
      <P>
